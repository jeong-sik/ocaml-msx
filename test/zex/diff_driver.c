...
static void fout(z80* z, uint8_t port, uint8_t v) { (void)z; (void)port; (void)v; }
...
int main(int argc, char** argv) {
  ...
  for (long n = 0; n < max_steps; n++) {
    ...
    printf("%ld pc=%04x af=%04x bc=%04x de=%04x hl=%04x ix=%04x iy=%04x sp=%04x\n",
           n, cpu.pc, (cpu.a << 8) | fl, (cpu.b << 8) | cpu.c,
